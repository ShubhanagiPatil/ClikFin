...
public class OurPartnersFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ((DashboardActivity) context).setNavigationTitle(getString(R.string.nav_our_partners));
        return inflater.inflate(R.layout.fragments_our_partners, container, false);
    }
}
